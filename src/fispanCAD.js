...
async function getDataCAD() { 
    const host = 'api.frankfurter.app';
    let fetchRes = await fetch(`https://${host}/2021-04-15..?to=CAD`);
    let data = await fetchRes.json();
    return (data);
}
async function displayDataCAD() {
    const display_data = await getDataCAD();
    const x1 = [];
    const y1 = [];
...
//   })()
module.exports.getDataCAD = getDataCAD;
module.exports.displayDataCAD = displayDataCAD;
// TESTING
//     const host = 'api.frankfurter.app';
